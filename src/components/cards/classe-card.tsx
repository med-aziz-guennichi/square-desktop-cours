...
import { BookOpen, MessageCircle, Pencil, Trash2, Users } from 'lucide-react';
...
export function ClassCard({
  ...
  const malePercentage =
    Math.round((students.genderDistribution.male / students.total) * 100) || 0;
  const femalePercentage =
    Math.round((students.genderDistribution.female / students.total) * 100) || 0;
  const navigate = useNavigate();
  return (
    <Card
      className="overflow-hidden transition-all hover:shadow-lg hover:shadow-primary/15 hover:cursor-pointer"
      onClick={() => navigate(`/dashboard/classes/matiere/${id}`)}
    >
