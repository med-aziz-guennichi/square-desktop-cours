            ...
            <DialogContent className="sm:max-w-[900px]">
                ...
                <div className="mt-4 p-4 border rounded-lg flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500">Ce cours sera accessible à d&apos;autres classes</p>
                    </div>
                ...
                {isPublic && (
                    <div className="mt-4">
                            ...
                            <div className="border rounded-lg p-4">
                                ...
                                <div className="space-y-2 max-h-[300px] overflow-y-auto">
                                    {filteredAvailableClasses.map((classe: Class) => (
                                        <div key={classe._id} className="flex items-center space-x-2 py-1 border-b">
                                            <Checkbox id={`available-${classe._id}`} onCheckedChange={() => addToSelection(classe)} />
                                            <label
                        ...
                        <div className="flex justify-center mt-4 space-x-2">
                            <Button variant="outline" size="icon" onClick={deselectAll} disabled={selectedClasses.length === 0}>
                ...
                <div className="flex justify-end space-x-2 mt-6">
                    ...
                    <Button onClick={() => {
                        onOpenChange(false);
                        navigate(`ajouter-cours?${new URLSearchParams({
