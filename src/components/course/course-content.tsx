                ...
                {data?.type === "Video" ? (
                    <div className="space-y-4">
                        ...
                        <div className="rounded-lg overflow-hidden border bg-card">
                            <VideoPlayer url={`${import.meta.env.VITE_API_BASE_URL}/desktop-app/video/${user?.enterprise}/${activeVideo}`} />
                        </div>
                    ...
                    <Tabs defaultValue="document-1" className="w-full">
                        ...
                        {data.studyMaterials.map((material, index) => (
                            <TabsContent key={index} value={`document-${index + 1}`} className="border rounded-lg p-4">
                                {/* <iframe
